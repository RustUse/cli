...
use crate::rustuse::facade::layout::{
    ...
    LICENSE_MIT, MAINTAINERS, MARKDOWNLINTIGNORE, README, RELEASE, RELEASE_PLZ_CONFIG, RELEASING,
    RUST_TOOLCHAIN, RUSTFMT_CONFIG, StandardPath, TAPLO_CONFIG, TRIVYIGNORE,
};
...
const FACADE_OPTIONAL_ROOT_FILES: &[StandardPath] = &[(GITLAB_CI_CONFIG, "GitLab CI")];
