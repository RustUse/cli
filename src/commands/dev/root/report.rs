...
use super::discover::{FacadeEntry, discover_facades, discover_root_repos};
use super::manifest_flags::manifest_shape_bucket;
use super::standards::{StandardFileReport, analyze_exact_standard_files};
use crate::commands::dev::utils::manifest::{FacadeManifestReport, analyze_manifests};
...
fn write_manifest_summary(
    ...
    write_manifest_issues(markdown, reports);
}
